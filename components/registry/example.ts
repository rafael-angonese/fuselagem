...
export const example: Registry = {
  ...
  "iphone-example": {
    name: "iphone-example",
    files: [{
      name: "IPhoneExample.tsx",
      file: "components/examples/iphone/iphone-example.tsx"
    }],
    component: React.lazy(
      () => import("@/components/examples/iphone/iphone-example"),
    ),
  },
  "iphone-with-image-example": {
    name: "iphone-example",
    files: [{
      name: "IPhoneWithImageExample.tsx",
      file: "components/examples/iphone/iphone-with-image-example.tsx"
    }],
    component: React.lazy(
  ...
  "marquee-example": {
    ...
    files: [{
      name: "MarqueeExample.tsx",
      file: "components/examples/marquee/marquee-example.tsx"
    }],
    component: React.lazy(
      () => import("@/components/examples/marquee/marquee-example"),
    ),
  },
  "word-rotate-example": {
    name: "word-rotate-example",
    files: [{
      name: "WordRotateExample.tsx",
      file: "components/examples/word-rotate/word-rotate-example.tsx"
    }],
    component: React.lazy(
  ...
  "lines-example": {
    ...
    files: [{
      name: "ShimmerButtonExample.tsx",
      file: "components/examples/lines/lines-example.tsx"
    }],
    component: React.lazy(
